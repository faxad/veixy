<%@ Page Language="C#" MasterPageFile="~/staff_mp.master" AutoEventWireup="true" CodeFile="staff_sentbox.aspx.cs" Inherits="staff_msgbox" Title="Veixy-Sent Messages" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="z-index: 101; left: 2px; width: 112px; position: absolute; top: 30px; height: 379px">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <asp:Panel ID="Panel2" runat="server" Width="632px" ScrollBars="Vertical" Height="230px">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="height: 21px" colspan="8">
                                            <asp:Label ID="token_noLabel" runat="server" Text='<%# Eval("msg_to") %>' __designer:wfdid="w153"></asp:Label></td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 71px; height: 18px" colspan="1">
                                            <asp:Label ID="msg_dateLabel" runat="server" Width="156px" Text='<%# Eval("msg_date") %>' __designer:wfdid="w154"></asp:Label></td>
                                        <td style="width: 257px; height: 18px" colspan="5"></td>
                                        <td style="height: 18px" colspan="1">
                                            <asp:Image ID="Image7" runat="server" ImageUrl="~/Images/reply_pic.jpg" __designer:wfdid="w155"></asp:Image></td>
                                        <td style="width: 100px; height: 18px" colspan="1">
                                            <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="OliveDrab" Font-Underline="False" Font-Bold="True" Enabled="False" NavigateUrl="#abc" __designer:wfdid="w156">Quick Reply</asp:HyperLink></td>
                                    </tr>
                                </tbody>
                            </table>
                            <asp:TextBox ID="TextBox1" runat="server" Width="607px" Font-Size="Small" Height="173px" Text='<%# Eval("msg_text") %>' Font-Names="Book Antiqua" TextMode="MultiLine" ReadOnly="True" __designer:wfdid="w157"></asp:TextBox>
                        </ItemTemplate>
