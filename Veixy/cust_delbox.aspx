<%@ Page Language="C#" MasterPageFile="~/top_mp4.master" AutoEventWireup="true" CodeFile="cust_delbox.aspx.cs" Inherits="cust_delbox" Title="Veixy-Deleted Messages" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="font-size: small; z-index: 101; left: 0px; width: 532px; position: absolute; top: 0px; height: 379px">
        <table style="font-size: x-small; width: 399px;">
            <tr>
                <td style="width: 79px">
                ...
                <td style="width: 79px">
                    <asp:LinkButton ID="LinkButton3" runat="server" CssClass="bar_format" Font-Bold="True"
                        Font-Size="X-Small" Font-Underline="False" ForeColor="OliveDrab" OnClick="LinkButton3_Click"
                ...
                <td style="width: 79px">
                    <asp:LinkButton ID="LinkButton5" runat="server" CssClass="bar_format" Font-Bold="True"
                        Font-Size="X-Small" Font-Underline="False" ForeColor="OliveDrab" OnClick="LinkButton5_Click"
                        Width="93px">Delete All</asp:LinkButton></td>
            </tr>
        </table>
        <div id="DIV1" onclick="return DIV1_onclick()" style="z-index: 101; left: -124px; width: 56px; position: absolute; top: 295px; height: 10px">
        ...
        <asp:Panel ID="Panel1" runat="server" Height="154px" ScrollBars="Vertical" Width="777px">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" Width="760px" Font-Size="Small" Height="1px" __designer:wfdid="w32" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ShowHeader="False" AutoGenerateColumns="False" DataKeyNames="msg_id" DataSourceID="SqlDataSource1">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <asp:Panel ID="Panel2" runat="server" Width="777px" Height="232px" ScrollBars="Vertical">
                    <asp:DataList ID="DataList11" runat="server" Width="561px" DataSourceID="SqlDataSource2">
                        <ItemTemplate>
                            <table style="font-size: small; background-color: #f5faf1" cellspacing="0" width="758">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 50px; height: 21px">
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("msg_from") %>'></asp:Label></td>
                            ...
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Eval("msg_text") %>' Font-Size="Small" Width="752px" Height="175px" ReadOnly="True" TextMode="MultiLine" Font-Names="Book Antiqua"></asp:TextBox>
                        </ItemTemplate>
                    </asp:DataList><asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CRM_dbConnectionString %>" SelectCommand="SELECT [msg_id], [msg_to],[msg_from], [msg_date], [msg_text] FROM [msg_box] WHERE ([msg_id] = @msg_id)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="GridView1" PropertyName="SelectedValue" Name="msg_id" Type="Decimal"></asp:ControlParameter>
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <a name="abc"></a>
                    <div style="z-index: 101; left: 281px; width: 198px; position: absolute; top: 267px; height: 22px" class="txt_boxx">
                        <table>
                            <tbody>
                                <tr>
                                    <td style="font-size: small; color: gainsboro; height: 23px" colspan="2">
                                        <asp:Label ID="Label2" runat="server" Text="Select a message to view the details" Width="206px"></asp:Label></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
