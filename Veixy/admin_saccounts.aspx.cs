...
public partial class admin_saccounts : System.Web.UI.Page
{
    ...
    protected void LinkButton4_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand my_insert = new SqlCommand("UPDATE staff_info SET acc_status='" + DropDownList2.SelectedItem.Text + "' WHERE staff_id='" + temp + "';", conn);
            conn.Open();
