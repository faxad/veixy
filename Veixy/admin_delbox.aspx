<%@ Page Language="C#" MasterPageFile="~/admin_mp.master" AutoEventWireup="true" CodeFile="admin_delbox.aspx.cs" Inherits="admin_reg_pending" Title="Veixy-Deleted Messages" EnableEventValidation="false" %>
    ...
    <table border="0" cellspacing="0" style="width: 825px; height: 27px">
        <tr>
            ...
            <td colspan="3" style="height: 21px; background-color: #f5faf1">
                ...
                <asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="LightGray" Text="--- Deleted Messages"
    ...
    <div style="z-index: 101; left: 114px; width: 112px; position: absolute; top: 30px; height: 379px">
            ...
            <tr>
                ...
                <td style="width: 79px">
                    <asp:LinkButton ID="LinkButton4" runat="server" CssClass="bar_format" Font-Bold="True"
                        ...
                        Width="100px" Enabled="False">Compose Reply</asp:LinkButton></td>
                <td style="width: 79px">
                ...
                <td style="width: 79px">
                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="bar_format" Font-Bold="True"
                        Font-Size="Small" Font-Underline="False" ForeColor="OliveDrab"
                        Width="109px" Enabled="False">Forward Message</asp:LinkButton></td>
                <td style="width: 79px">
                ...
                <td style="width: 79px">
                    <asp:LinkButton ID="LinkButton2" runat="server" CssClass="bar_format" Font-Bold="True"
                        ...
                        Width="102px">Restore Message</asp:LinkButton></td>
                <td style="width: 79px">
        ...
        <asp:Panel ID="Panel1" runat="server" Height="154px" ScrollBars="Vertical" Width="707px">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" Width="683px" Font-Size="Small" Height="1px" ShowHeader="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="msg_id" OnRowDataBound="GridView1_RowDataBound">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CRM_dbConnectionString %>"
                SelectCommand="SELECT [msg_from], [msg_id], [subject], [msg_img], [to_type], [msg_to],CONVERT (VARCHAR, msg_date, 101) AS msg_date FROM [msg_box] WHERE (([msg_from] = @msg_from) OR ([msg_to] = @msg_to)) AND ([box_type])=@deleted ORDER BY msg_id DESC, msg_date DESC">
                <SelectParameters>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 50px; height: 21px">
                                            <asp:Label ID="token_noLabel" runat="server" __designer:wfdid="w49" Text='<%# Eval("msg_to") %>'></asp:Label></td>
                                        <td style="width: 50px; height: 21px" align="center">From:</td>
                                        <td style="width: 50px; height: 21px">
                                            <asp:Label ID="Label1" runat="server" __designer:wfdid="w49" Text='<%# Eval("msg_from") %>'></asp:Label></td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 71px; height: 18px" colspan="1">
                                            <asp:Label ID="msg_dateLabel" runat="server" Width="156px" __designer:wfdid="w50" Text='<%# Eval("msg_date") %>'></asp:Label></td>
                                        <td style="width: 257px; height: 18px" colspan="5"></td>
                                        <td style="height: 18px" colspan="1">
                                            <asp:Image ID="Image7" runat="server" ImageUrl="~/Images/reply_pic.jpg" __designer:wfdid="w51"></asp:Image></td>
                                        <td style="width: 100px; height: 18px" colspan="1">
                                            <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="OliveDrab" Font-Underline="False" Font-Bold="True" __designer:wfdid="w52" NavigateUrl="#abc" Enabled="False">Quick Reply</asp:HyperLink></td>
                                    </tr>
                                </tbody>
                            </table>
                            <asp:TextBox ID="TextBox1" runat="server" Width="680px" Font-Size="Small" Height="222px" __designer:wfdid="w53" Text='<%# Eval("msg_text") %>' TextMode="MultiLine" Font-Names="Book Antiqua" ReadOnly="True"></asp:TextBox>
                        </ItemTemplate>
                    </asp:DataList><asp:SqlDataSource ID="SqlDataSource2" runat="server" SelectCommand="SELECT [msg_id], [msg_to],[msg_from], [msg_date], [msg_text] FROM [msg_box] WHERE ([msg_id] = @msg_id)" ConnectionString="<%$ ConnectionStrings:CRM_dbConnectionString %>" __designer:wfdid="w292">
                        <SelectParameters>
                            ...
                            <tbody>
                                <tr>
                                    <td style="font-size: small; color: gainsboro; height: 23px" colspan="2">
                                        <asp:Label ID="Label2" runat="server" Width="212px" Text="Select a message to view the details"></asp:Label></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <asp:TreeView ID="TreeView1" runat="server" Height="90px" LineImagesFolder="~/TreeLineImages"
            ...
            <Nodes>
                <asp:TreeNode Text="Message Box" Value="Message Box" NavigateUrl="~/admin_compose.aspx">
                    ...
                    <asp:TreeNode Text="Deleted" Value="Deleted" NavigateUrl="~/admin_delbox.aspx" Selected="True"></asp:TreeNode>
                </asp:TreeNode>
            </Nodes>
