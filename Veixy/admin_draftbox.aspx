<%@ Page Language="C#" MasterPageFile="~/admin_mp.master" AutoEventWireup="true" CodeFile="admin_draftbox.aspx.cs" Inherits="admin_draftbox" Title="Veixy-Drafts" EnableEventValidation="false" %>
    ...
    <table border="0" cellspacing="0" style="width: 825px; height: 27px">
        <tr>
            ...
            <td colspan="3" style="height: 21px; background-color: #f5faf1">
                ...
                <asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="LightGray" Text="--- Saved Drafts"
    ...
    <div style="z-index: 101; left: 114px; width: 112px; position: absolute; top: 30px; height: 379px">
            ...
            <tr>
                ...
                <td style="width: 79px">
                    <asp:LinkButton ID="LinkButton2" runat="server" CssClass="bar_format" Font-Bold="True"
                        ...
                        Width="106px">Delete Message</asp:LinkButton></td>
            </tr>
        </table>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="154px" ScrollBars="Vertical" Width="707px">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" Width="684px" Font-Size="Small" Height="1px" OnRowDataBound="GridView1_RowDataBound" DataKeyNames="msg_id" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ShowHeader="False">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="height: 21px" colspan="8">
                                            <asp:Label ID="token_noLabel" runat="server" __designer:wfdid="w232" Text='<%# Eval("msg_to") %>'></asp:Label></td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 71px; height: 18px" colspan="1">
                                            <asp:Label ID="msg_dateLabel" runat="server" Width="156px" __designer:wfdid="w233" Text='<%# Eval("msg_date") %>'></asp:Label></td>
                                        <td style="width: 257px; height: 18px" colspan="5"></td>
                                        <td style="height: 18px" colspan="1">
                                            <asp:Image ID="Image7" runat="server" ImageUrl="~/Images/send_but.jpg" __designer:wfdid="w234"></asp:Image></td>
                                        <td style="width: 100px; height: 18px" colspan="1">
                                            <asp:LinkButton ID="LinkButton7" OnClick="LinkButton7_Click" runat="server" __designer:dtid="9288674231451669" Width="93px" ForeColor="OliveDrab" Font-Underline="False" Font-Size="Small" Font-Bold="True" CssClass="bar_format" __designer:wfdid="w235">Send Message</asp:LinkButton></td>
                                    </tr>
                                </tbody>
                            </table>
                            <asp:TextBox ID="TextBox1" runat="server" Width="680px" Font-Size="Small" Height="222px" __designer:wfdid="w236" Text='<%# Eval("msg_text") %>' TextMode="MultiLine" Font-Names="Book Antiqua"></asp:TextBox>
                        </ItemTemplate>
                            ...
                            <tbody>
                                <tr>
                                    <td style="font-size: small; color: gainsboro; height: 23px" colspan="2">
                                        <asp:Label ID="Label2" runat="server" Width="208px" Text="Select a message to view the details"></asp:Label></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <asp:TreeView ID="TreeView1" runat="server" Height="90px" LineImagesFolder="~/TreeLineImages"
            ...
            <Nodes>
                <asp:TreeNode Text="Message Box" Value="Message Box" NavigateUrl="~/admin_compose.aspx">
                    ...
                    <asp:TreeNode Text="Drafts" Value="Drafts" NavigateUrl="~/admin_draftbox.aspx" Selected="True"></asp:TreeNode>
