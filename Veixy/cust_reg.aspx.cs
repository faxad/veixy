...
public partial class cust_reg : System.Web.UI.Page
{
    ...
    {
        SqlCommand my_insert = new SqlCommand("INSERT INTO user_info(user_id,user_pass,f_name,l_name,dob,country,city,user_contact_no,user_contact_no2,email_add,postal_address) VALUES('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox13.Text + "','" + DropDownList1.SelectedItem.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "','" + TextBox9.Text + "','" + TextBox10.Text + "');", conn);
        conn.Open();
