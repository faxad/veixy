    ...
    protected void LinkButton7_Click(object sender, EventArgs e)
    {
            ...
            try
            {
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    if (dr[0].ToString() == TextBox1.Text)
                    {
                        ...
                        SqlCommand my_insert = new SqlCommand("INSERT INTO msg_box(msg_from,msg_date,subject,msg_text,msg_to,msg_img,from_type,to_type,box_type) VALUES('" + Session["user_session"].ToString() + "','" + my_time + "',@subject,@msg_text,'" + TextBox1.Text + "','Images/msg_unchecked.jpg','admin','cust','inbox');", conn);
                        SqlCommand my_insert2 = new SqlCommand("INSERT INTO msg_box(msg_from,msg_date,subject,msg_text,msg_to,msg_img,from_type,to_type,box_type) VALUES('" + Session["user_session"].ToString() + "','" + my_time + "',@subject,@msg_text,'" + TextBox1.Text + "','Images/msg_checked.jpg','admin','cust','sent');", conn);
            ...
            foreach (ListItem li in ListBox1.Items)
            {
                ...
                try
                {
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        {
                            status_label.Text = dr[0].ToString();
                            SqlCommand my_insert = new SqlCommand("INSERT INTO msg_box(msg_from,msg_date,subject,msg_text,msg_to,msg_img,from_type,to_type,box_type) VALUES('" + Session["user_session"].ToString() + "','" + my_time + "',@subject,@msg_text,'" + li.Text + "','Images/msg_unchecked.jpg','admin','cust','inbox');", conn);
                            SqlCommand my_insert2 = new SqlCommand("INSERT INTO msg_box(msg_from,msg_date,subject,msg_text,msg_to,msg_img,from_type,to_type,box_type) VALUES('" + Session["user_session"].ToString() + "','" + my_time + "',@subject,@msg_text,'" + li.Text + "','Images/msg_checked.jpg','admin','cust','sent');", conn);
                            my_insert.Parameters.Add("@subject", 50).Value = TextBox3.Text;
                            my_insert.Parameters.Add("@msg_text", 8000).Value = TextBox4.Text;
                            my_insert2.Parameters.Add("@subject", 50).Value = TextBox3.Text;
                            my_insert2.Parameters.Add("@msg_text", 8000).Value = TextBox4.Text;
        ...
        else if (RadioButtonList1.SelectedItem.Text == "Client Group")
        {
            ...
            try
            {
                ...
                {
                    status_label.Text = dr[0].ToString();
                    SqlCommand my_insert = new SqlCommand("INSERT INTO msg_box(msg_from,msg_date,subject,msg_text,msg_to,msg_img,from_type,to_type,box_type) VALUES('" + Session["user_session"].ToString() + "','" + my_time + "',@subject,@msg_text,'" + dr[0].ToString() + "','Images/msg_unchecked.jpg','admin','cust','inbox');", conn);
                    SqlCommand my_insert2 = new SqlCommand("INSERT INTO msg_box(msg_from,msg_date,subject,msg_text,msg_to,msg_img,from_type,to_type,box_type) VALUES('" + Session["user_session"].ToString() + "','" + my_time + "',@subject,@msg_text,'" + dr[0].ToString() + "','Images/msg_checked.jpg','admin','cust','sent');", conn);
                    my_insert.Parameters.Add("@subject", 50).Value = TextBox3.Text;
                    my_insert.Parameters.Add("@msg_text", 8000).Value = TextBox4.Text;
                    my_insert2.Parameters.Add("@subject", 50).Value = TextBox3.Text;
                    my_insert2.Parameters.Add("@msg_text", 8000).Value = TextBox4.Text;
            ...
            foreach (ListItem li in ListBox1.Items)
            {
                ...
                try
                {
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        {
                            status_label.Text = dr[0].ToString();
                            SqlCommand my_insert = new SqlCommand("INSERT INTO msg_box(msg_from,msg_date,subject,msg_text,msg_to,msg_img,from_type,to_type,box_type) VALUES('" + Session["user_session"].ToString() + "','" + my_time + "',@subject,@msg_text,'" + li.Text + "','Images/msg_unchecked.jpg','admin','staff','inbox');", conn);
                            SqlCommand my_insert2 = new SqlCommand("INSERT INTO msg_box(msg_from,msg_date,subject,msg_text,msg_to,msg_img,from_type,to_type,box_type) VALUES('" + Session["user_session"].ToString() + "','" + my_time + "',@subject,@msg_text,'" + li.Text + "','Images/msg_checked.jpg','admin','staff','sent');", conn);
                            my_insert.Parameters.Add("@subject", 50).Value = TextBox3.Text;
                            my_insert.Parameters.Add("@msg_text", 8000).Value = TextBox4.Text;
                            my_insert2.Parameters.Add("@subject", 50).Value = TextBox3.Text;
                            my_insert2.Parameters.Add("@msg_text", 8000).Value = TextBox4.Text;
            ...
            try
            {
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    if (dr[0].ToString() == TextBox1.Text)
                    {
                        ...
                        my_insert2.ExecuteNonQuery();
                        conn.Close();
                        status_label.Text = "Message Saved";
                        not_found = 0;
                    }
                }
            }
