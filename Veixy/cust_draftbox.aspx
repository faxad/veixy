<%@ Page Language="C#" MasterPageFile="~/top_mp4.master" AutoEventWireup="true" CodeFile="cust_draftbox.aspx.cs" Inherits="cust_draftbox" Title="Veixy-Drafts" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="z-index: 101; left: 0px; width: 295px; position: absolute; top: 0px; height: 379px">
            ...
            <tr>
                ...
                <td style="width: 79px">
                    <asp:LinkButton ID="LinkButton2" runat="server" CssClass="bar_format" Font-Bold="True"
                        ...
                        Width="93px">Delete Permanently</asp:LinkButton></td>
            </tr>
        </table>
        <div id="DIV1" onclick="return DIV1_onclick()" style="z-index: 101; left: -122px; width: 72px; position: absolute; top: 301px; height: 10px">
            <img src="Images/drafts.jpg" />
        </div>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="154px" ScrollBars="Vertical" Width="777px">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" Width="760px" Font-Size="Small" Height="1px" __designer:wfdid="w30" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ShowHeader="False" AutoGenerateColumns="False" DataKeyNames="msg_id" DataSourceID="SqlDataSource1">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <asp:Panel ID="Panel2" runat="server" Width="777px" ScrollBars="Vertical" Height="232px">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="height: 21px" colspan="8">
                                            <asp:Label ID="token_noLabel" runat="server" Text='<%# Eval("msg_to") %>' __designer:wfdid="w41"></asp:Label></td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 71px; height: 18px" colspan="1">
                                            <asp:Label ID="msg_dateLabel" runat="server" Width="156px" Text='<%# Eval("msg_date") %>' __designer:wfdid="w42"></asp:Label></td>
                                        <td style="width: 257px; height: 18px" colspan="5"></td>
                                        <td style="height: 18px" colspan="1">
                                            <asp:Image ID="Image7" runat="server" ImageUrl="~/Images/send_but.jpg" __designer:wfdid="w43"></asp:Image></td>
                                        <td style="width: 100px; height: 18px" colspan="1">
                                            <asp:LinkButton ID="LinkButton7" OnClick="LinkButton7_Click" runat="server" Width="93px" ForeColor="OliveDrab" Font-Underline="False" Font-Size="X-Small" Font-Bold="True" CssClass="bar_format" __designer:wfdid="w44">Send Message</asp:LinkButton></td>
                                    </tr>
                                </tbody>
                            </table>
                            <asp:TextBox ID="TextBox1" runat="server" Width="752px" Font-Size="Small" Height="175px" Text='<%# Eval("msg_text") %>' __designer:wfdid="w45" TextMode="MultiLine" Font-Names="Book Antiqua"></asp:TextBox>
                        </ItemTemplate>
                    ...
                    <a name="abc"></a>
                    <div style="z-index: 101; left: 283px; width: 198px; position: absolute; top: 267px; height: 22px" class="txt_boxx">
                        <table>
                            <tbody>
                                <tr>
                                    <td style="font-size: small; color: gainsboro; height: 23px" colspan="2">
                                        <asp:Label ID="Label2" runat="server" Width="209px" Text="Select a message to view the details"></asp:Label></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
