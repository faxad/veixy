...
public partial class staff_aapps : System.Web.UI.Page
{
    ...
    protected void LinkButton5_Click(object sender, EventArgs e)
    {
        ...
        if (ds0.Tables[0].Rows.Count != 0)
        {
            ...
            SqlCommand my_update = new SqlCommand("UPDATE cust_appoint SET lock_by='none' WHERE app_no='" + temp_id + "';", conn);
            SqlCommand my_insert22 = new SqlCommand("DELETE FROM staff_loc WHERE user_loc_id='" + GridView1.SelectedValue.ToString() + "' AND loc_type='App';", conn);
            conn.Open();
    ...
    protected void LinkButton51_Click(object sender, EventArgs e)
    {
        ...
        int x = GridView1.SelectedIndex;
        SqlCommand my_update = new SqlCommand("UPDATE cust_appoint SET lock_by='none' WHERE app_no='" + temp_id + "';", conn);
        SqlCommand my_insert2 = new SqlCommand("DELETE FROM staff_loc WHERE user_loc_id='" + GridView1.SelectedValue.ToString() + "' AND loc_type='App';", conn);
        conn.Open();
        my_insert2.ExecuteNonQuery();
        my_update.ExecuteNonQuery();
